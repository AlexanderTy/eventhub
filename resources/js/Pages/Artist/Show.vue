                            ...
                            <div class="col-span-2 p-3 flex flex-col justify-between">
                                <div class="flex flex-row justify-between">
                                    ...
                                    <div class="relative z-10">
                                        <button class="text-black self-end hover:text-primary" type="button" @click="open = !open" >
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4 24" fill="currentColor" class="w-7 h-7">
                                                <path fill-rule="evenodd" d="M10.5 6a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm0 6a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm0 6a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z" clip-rule="evenodd" />
                                            </svg>
                                        </button>
                                        <div v-show="open" class="absolute p-3 right-0 top-6 flex flex-col justify-start text-left w-36 bg-white text-black rounded-md shadow-[-7px_7px_33px_rgba(114,121,125,0.25)]">
                    ...
                    <div v-show="secondaryActiveTab === 'previous'" class="absolute top-0 left-0 h-full w-full p-5 flex flex-col gap-4 overflow-scroll">
                        <div v-for="event in artist.events" class="bg-white-secondary w-full h-24 rounded-md grid grid-cols-3">
                            ...
                            <div class="col-span-2 p-3 flex flex-col justify-between">
                                ...
                                <p class="text-xs">0 out of 32 events</p>
                            </div>
                        </div>
                    </div>
