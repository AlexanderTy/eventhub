<template>
    <Link
        ...
        <div class="p-2.5">
            <img v-if="event.image" alt="" class="rounded-xl h-32 w-full relative object-cover" :src="'/storage/images/events/' + event.image"/>
            ...
            <div class="flex flex-row gap-2.5">
                <div class="flex text-tab-secondary h-[48px]" >
                    ...
                    >
                        ...
                        <img v-if="artist.image" alt="" class="w-full h-full object-cover object-top" :src="'/storage/images/artists/' + artist?.image"/>
                        <svg v-else
