<template>
    <div class="">
        <div @click="open = !open" v-click-away="onClickAway"
            ...
            <div class="text-tab-secondary w-9 h-9 mr-4 rounded-full shrink-0 overflow-hidden">
                <img v-show="$page.props.profile.image" alt="" class="w-full h-full object-cover object-top" :src="'/images/artists/' + $page.props.profile.image"/>
                <svg v-show="!$page.props.profile.image" class="w-full h-full" viewBox="0 0 167 167" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
