<template>
    <div class="flex flex-row items-center gap-2.5">
        <button @click="selectedButton = 'cards';$emit('btnClick', 'cards')"  :class="selectedButton === 'cards' ? 'text-primary' : 'text-gray-600'">
        ...
        <button @click="selectedButton = 'list'; $emit('btnClick', 'list')"  :class="selectedButton === 'list' ? 'text-primary' : 'text-gray-600'">
