            ...
            <div class="flex gap-8">
                ...
                <form class="flex flex-row gap-7" @submit.prevent="submit">
                    <Input
                        ...
                        :class="'shadow w-96 2xl:w-[484px] h-9 shadow-[5px_4px_17px_-2px_rgba(0,0,0,0.15)]'"
                        bg="bg-white"
...
<!--                    <Select
                        ...
                        class="shadow rounded w-44 h-32 shadow-[5px_4px_17px_-2px_rgba(0,0,0,0.15)]"
                    ...
                    >
                        <option
                            ...
                            :key="key"
                            :value="key"
                            :class="filter.filterArray.includes(key) ? 'bg-red-500' : ''"
...
export default {
    ...
    mounted() {
        console.log(this.filter.sortOption);
    },
    // methods
    methods: {
        onClickAway(event) {
