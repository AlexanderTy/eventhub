            ...
            <div class="flex flex-row gap-2.5">
                <div class="flex">
                    <div v-for="(artist, index) in event.artists" v-show="index < 2"
                         class="text-white-secondary w-10 h-10 rounded-full shrink-0 overflow-hidden"

                    >
    <!--                    <img v-show="event.artists[0].image" alt="" class="w-full" :src="'/images/artists/' + event.artists[0].image"/>-->
                        <img v-if="artist.image" alt="" class="w-full" :src="'/images/artists/' + artist.image"/>
